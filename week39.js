...
const sum = tall.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
...
function summer(liste) {
    ...
    return liste.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
}
...
const differans = andreTall.reduce((accumulator, currentValue) => accumulator - currentValue);
...
function differansier(liste) {
    ...
    return liste.reduce((accumulator, currentValue) => accumulator - currentValue);
}
const andreTall = [6, 7, 8, 9]
...
function multipliser(liste) {
    return liste.reduce((accumulator, currentValue) => accumulator * currentValue, 1);
}
